		...
		<div class="lt_body_wrapper">
			<div class="lt_body lt_body_back">
				...
				<div class="lt_body_contact_form">
					...
					<tr> <td> <input type="tel" name="tel" placeholder="Optional: telephone number"> </td> </tr>
					<tr> <td> <textarea name="inquiry" placeholder="Please enter your message..."></textarea> </td> </tr>
